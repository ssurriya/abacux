...
import 'package:abacux/widgets/product_item.dart';
...
class _ProductScreenState extends State<ProductScreen> {
  ...
  _sortByName() {
    ...
    _groupByAlphabet(_productDetails);
  }

  _groupByAlphabet(List<Product> _productDetails) {
    groupByAlphabet = groupBy(_productDetails, (Product obj) {
                                  ...
                                  children: [
                                    ...
                                    ListView.separated(
                                      ...
                                      itemBuilder:
                                        ...
                                        return ProductItems(e.value[index]);
                                      },
                                    )
                                  ],
                                );
  ...
  _searchOperation(String searchText) {
    print(searchText);
    List<Product> filteredCustomer = [];
    filteredCustomer = _productDetails
