...
import 'add_or_edit_warehouse.dart';

class WarehousesScreen extends StatefulWidget {
  static const route = "/warehouses_screen";
...
class _WarehousesScreenState extends State<WarehousesScreen> {
  ...
  List<WarehousesListElement> _wareHouseList = [];
  ...
  _getWarehouseList() async {
    ...
    await WareHousesService.getInstance().wareHouseList(body).then((value) {
      print(value);
      _wareHouseList = value.warehousesList;
      setState(() {
        _isLoading = true;
      });
    }).catchError((onError) {
  ...
  _groupByAlphabet(List<WarehousesListElement> _estimateDetails) {
    groupByAlphabet = groupBy(_estimateDetails, (WarehousesListElement obj) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            Navigator.pushReplacementNamed(context, AddOrEditWarehouse.route);
          },
  ...
  _searchOperation(String searchText) {
    print(searchText);
    List<WarehousesListElement> filteredCustomer = [];
  ...
  _getWarehouseItem(WarehousesListElement warehousesListElement) {
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => AddOrEditWarehouse(
                  warehousesListElement: warehousesListElement,
                )));
      },
      child: Container(
        color: Colors.white,
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        warehousesListElement.warehouseCode,
                        style: TextStyle(
                            fontSize: 14,
                            letterSpacing: 0.5,
                    ...
                    Padding(
                      padding: const EdgeInsets.only(left: 8.0),
                      child: Text(
                        warehousesListElement.warehouseName,
                        style: TextStyle(
                            fontSize: 12,
                            letterSpacing: 0.5,
