...
class AddOrEditTax extends StatefulWidget {
  static const route = "/add_or_edit_Tax";
  AddOrEditTax({this.taxname});
  final TaxtypesList taxname;

  @override
  State<AddOrEditTax> createState() => _AddOrEditTaxState();
}

class _AddOrEditTaxState extends State<AddOrEditTax> {
  TextEditingController taxName = TextEditingController();
  ...
  void initState() {
    ...
    if (widget.taxname != null) {
      setState(() {
        _isEdit = true;
        taxName.text = widget.taxname.tax;
      });
    }
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
            ...
            onPressed: () {
              Navigator.pushReplacementNamed(context, TaxScreen.route);
            }),
        actions: [
          _isEdit
              ? IconButton(
          ...
          IconButton(
              ...
              onPressed: () async {
                ...
                if (_isEdit) body['id'] = widget.taxname.id.toString();
                ...
                _isEdit
                    ...
                    : await TaxService.getInstance().addTax(body).then((value) {
                        _navigate();
                      }).catchError((onError) {});
              })
        ],
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            textField(taxName, "Tax Name", onchanged: (value) {}),
          ],
        ),
      ),
    );
