...
import 'package:abacux/screens/estimate/add_or_edit_additional_charges.dart';
...
import 'add_product_in_purchase_bill_screen.dart';
import 'purchase_bill_additional_charge.dart';
import 'purchase_bill_screen.dart';

class AddOrEditPurchaseBillScreen extends StatefulWidget {
  static const route = "/add_or_edit_purchase_bill";

  @override
  _AddOrEditPurchaseBillScreenState createState() =>
      _AddOrEditPurchaseBillScreenState();
}

class _AddOrEditPurchaseBillScreenState
    extends State<AddOrEditPurchaseBillScreen> {
  ...
  _loadUnchangedValue(EstimateEditUsingId estimateEditUsingId) {
    ...
    _billDate = DateTime.parse(estimateEditUsingId.estimatesVal.estimateDate);
    billDateController.text = _dateFormat(_billDate);
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              Text(
                _isEdit ? "Edit Purchase Bill" : "Add Purchase Bill",
  ...
  Widget _getColumnWidget() {
    return Column(
      children: [
        ...
        dropDown(),
        // textField(vendorName, "Vendor Name"),
        // textField(purchaseOrderDate, "Date"),
        dateTextField(billDateController, "Bill Date", () {
          FocusScope.of(context).requestFocus(new FocusNode());
          _selectListDateFrom(context);
        }),
        dateTextField(dueDateController, "Due Date", () {}),
        Padding(
              ...
              InkWell(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => AddProductPurchaseBill()));
                },
                child: Row(
                  children: [
                    Icon(
  ...
  createBodyForEstimateStore() {
    ...
    Map body = {
      ...
      "estimate_settings": "1",
      "hidden_prefix": "EO",
      "estimate_date": _billDate.toString(),
