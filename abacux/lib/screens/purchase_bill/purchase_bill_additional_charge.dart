...
class PurchaseBillAdditionalCharges extends StatefulWidget {
  static const route = "/purchase_bill_additional_charge";

  const PurchaseBillAdditionalCharges({this.productValue, this.isUpdate});

  final dynamic productValue;
  final bool isUpdate;

  @override
  _PurchaseBillAdditionalChargesState createState() =>
      _PurchaseBillAdditionalChargesState();
}

class _PurchaseBillAdditionalChargesState
    extends State<PurchaseBillAdditionalCharges> {
  ...
  _insertPurchaseBillProductToLocal() async {
    ...
    await PurchaseBillService.getInstance()
        .insertPurchaseBillAdditionalCharges(purchaseBillProduct)
        .then((value) {
  ...
  _updatePurchaseBillProductToLocal() async {
    _loadPurchaseBillProductValue();
    await PurchaseBillService.getInstance()
        .updatePurchaseBillAdditionalCharges(purchaseBillProduct)
        .then((value) {
      Navigator.pushReplacementNamed(
          context, AddOrEditPurchaseBillScreen.route);
    });
