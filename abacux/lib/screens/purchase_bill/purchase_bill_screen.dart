...
class PurchaseBillScreen extends StatefulWidget {
  static const route = "/purchase_bill_screen";
  const PurchaseBillScreen({Key key}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              ListView.separated(
                ...
                itemCount: purchaseBillLst.length,
                itemBuilder: (context, index) {
                  return PurchaseBillItem(purchaseBillLst[index]);
                },
              ),
            ],
          ),
