...
import 'package:abacux/services/credit_note_service.dart';
...
import 'add_product_in_credit_note_screen.dart';

class AddOrEditCreditNoteScreen extends StatefulWidget {
  static const route = "/add_or_edit_credit_note";
  const AddOrEditCreditNoteScreen({this.creditNote});

  final dynamic creditNote;

  @override
  _AddOrEditCreditNoteScreenState createState() =>
      _AddOrEditCreditNoteScreenState();
}

class _AddOrEditCreditNoteScreenState extends State<AddOrEditCreditNoteScreen> {
  var _formKey = GlobalKey<FormState>();

  TextEditingController creditNoteNumber = TextEditingController();
  TextEditingController poNo = TextEditingController();
  TextEditingController vendorName = TextEditingController();
  TextEditingController creditNoteDateController = TextEditingController();
  ...
  _getCreditNoteProduct() async {
    setState(() {
      productList = [];
    });
    await CreditNoteService.getInstance()
        .getCreditNoteProductFromLocal()
        .then((value) {
      value.map((e) {
        setState(() {
          productList.add(e);
  ...
  _getAdditionalChargesValueFromLocal() async {
    ...
    //     .getPurchaseBillAdditionalFromLocal()
    //     .then((value) {
    //   print(value);
    //   setState(() {
    //     value.map((e) {
  ...
  _setDateTime() {
    creditNoteDateController.text = _dateFormat(_creditNoteDate);
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              Text(
                _isEdit ? "Edit Credit Note" : "Add Credit Note",
  ...
  Widget _getColumnWidget() {
    return Column(
      children: [
        textField(creditNoteNumber, "Credit Note Number", isRead: true),
        dropDown(),
        textField(emailController, "Email"),
        dateTextField(creditNoteDateController, "Credit Note Date", () {
              ...
              InkWell(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => AddProductInCreditNote()));
                },
                child: Row(
                  children: [
                    Icon(
    ...
    return Row(
      children: [
        InkWell(
          onTap: () {
            // Navigator.of(context).push(MaterialPageRoute(
            //     builder: (context) => PurchaseBillAdditionalCharges()));
          },
          child: Row(
            children: [
              Icon(
        ...
        child: Padding(
          ...
          child: Container(
            ...
            child: DropdownSearch<Customer>(
              ...
              onChanged: (Customer value) async {
