...
class CustomerDetailScreen extends StatefulWidget {
  ...
  CustomerDetailScreen({this.customerDetails});
...
class _CustomerDetailScreenState extends State<CustomerDetailScreen>
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        Navigator.pushReplacementNamed(context, "/new_customer");
                      ...
                      Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              '${widget.customerDetails.customerName}',
                        ...
                        child: Column(
                          children: [
                            _textField(_mobile1, "Mobile 1",
                                widget.customerDetails.contactNoOne.toString()),
                            _textField(_mobile2, "Mobile 2",
                                widget.customerDetails.contactNoTwo.toString()),
                            _textField(_gstNo, "Gst No   ",
                                widget.customerDetails.gstinNo.toString()),
                            _textField(_panNo, "Pan No  ",
                                widget.customerDetails.panNo.toString()),
                            _textField(
                                _address,
                                "Address",
                                widget.customerDetails.customerAddress
                                    .toString()),
                          ],
                        ),
                      ),
          ...
          onPressed: () {
            CustomerService()
              ...
              Navigator.pushNamedAndRemoveUntil(
                  context, '/new_customer', (Route<dynamic> route) => false);
            });
          },
          textColor: Theme.of(context).primaryColor,
          child: const Text('OK'),
