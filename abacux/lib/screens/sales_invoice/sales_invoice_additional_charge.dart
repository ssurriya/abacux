...
class SalesInvoiceAdditionalCharge extends StatefulWidget {
  static const route = "/additional_charge_sales_invoice";
  const SalesInvoiceAdditionalCharge({this.productValue});

  final LocalAdditionalCharge productValue;

  @override
  _SalesInvoiceAdditionalChargeState createState() =>
      _SalesInvoiceAdditionalChargeState();
}

class _SalesInvoiceAdditionalChargeState
    extends State<SalesInvoiceAdditionalCharge> {
  ...
  void initState() {
    ...
    _getSalesInvoiceAdditionalIndex();
  ...
  _getSalesInvoiceAdditionalIndex() async {
  ...
  _insertAdditionalProductToLocal() async {
    ...
    await SalesInvoiceService.getInstance()
        .insertSalesInvoiceAdditionalChargesToLocal(additionalProduct)
        .then((value) {
  ...
  _updateAdditionalProductToLocal() async {
    _loadAdditionalProductValue();
    await SalesInvoiceService.getInstance()
        .updateSalesInvoiceAdditionalChargesToLocal(additionalProduct)
        .then((value) {
      Navigator.pushReplacementNamed(
          context, AddOrEditSalesInvoicesScreen.route);
    });
  ...
  _loadAdditionalProductValue() {
    print(salesInvoiceProductIndex);
    additionalProduct = {
      "id": isEdit ? widget.productValue.id : salesInvoiceProductIndex,
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  discountAmount(discountAmountController, "₹ Amount",
