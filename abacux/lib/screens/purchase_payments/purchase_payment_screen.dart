...
import 'package:abacux/services/purchase_payment_service.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:intl/intl.dart';
import "package:collection/collection.dart";

import 'add_or_edit_purchase_payment.dart';

class PurchasePaymentScreen extends StatefulWidget {
  static const route = "/purchase_payment_screen";
...
class _PurchasePaymentScreenState extends State<PurchasePaymentScreen> {
  ...
  List<PurchaseInvoicesList> _purchasePaymentList = [];
  ...
  void initState() {
    ...
    // _groupByAlphabet(_purchasePaymentList);
  }
  ...
  _getUserAndCompanyId() async {
    ...
    _getPurchasePaymentList();
  }

  _getPurchasePaymentList() async {
    Map body = {
      "user_id": userId.toString(),
      "company_id": companyId.toString(),
      "token": token
    };
    await PurchasePaymentService.getInstance()
        .getPurchasePaymentList(body)
        .then((value) {
      _purchasePaymentList = value.purchaseInvoicesList;
      _groupByAlphabet(_purchasePaymentList);
    }).catchError((onError) {});
  }
  ...
  _groupByAlphabet(List<PurchaseInvoicesList> purchasePaymentList) {
    groupByAlphabet = groupBy(purchasePaymentList, (PurchaseInvoicesList obj) {
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.pushReplacementNamed(
                context, AddOrEditPurchasePayment.route);
          },
  ...
  Widget salesReceiptItem(PurchaseInvoicesList salesReceipt) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        salesReceipt.invoiceNo.toString(),
                        style: TextStyle(
                            fontSize: 12,
                            letterSpacing: 0.5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(right: 8.0),
                      child: Text(
                        salesReceipt.grandTotal.toString(),
                        style: TextStyle(
                  ...
                  this.appBarTitle = new TextField(
                    ...
                    decoration: new InputDecoration(
                        prefixIcon: new Icon(Icons.search,
                            color: AppConstant().appThemeColor),
                        hintText: "Search Purchase Payment",
