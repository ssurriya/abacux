...
class AddProductInDebitNote extends StatefulWidget {
  static const route = "/add_or_edit_debit_note_product";

  const AddProductInDebitNote({this.productValue, this.isUpdate = false});

  final dynamic productValue;
  final bool isUpdate;

  @override
  _AddProductInDebitNoteState createState() => _AddProductInDebitNoteState();
}

class _AddProductInDebitNoteState extends State<AddProductInDebitNote> {
  ...
  _insertPurchaseBillProductToLocal() async {
    ...
    await DebitNoteService.getInstance()
        .insertDebitNoteProductFromLocal(purchaseBillProduct)
        .then((value) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            Text(
              isEdit ? "Edit Debit Note" : "Add Debit Note",
            ...
            child: Column(
              children: [
                ...
                textField(_priceBeforeTaxController, "₹ Price (Before Tax)",
                    "Enter the price(Before Tax)", onchanged: (value) {
                ...
                textField(_discountPercentageController, "% Discount",
                    "Enter the discount", onchanged: (value) {
                  updateAllValuesChanges();
                }),

                textField(_discountAmountController, "₹ Discount Amount",
                    "Enter the discount amount", onchanged: (value) {
